...
//            timeline.play();
    ...
    public double getDisplayPosition(Date date) {
        ...
        //System.out.println(0.6 * range + getZeroPosition());
    ...
    public Date getValueForDisplay(double displayPosition) {
        length = getSide().isHorizontal() ? getWidth() : getHeight();
    ...
    public double averageTickGap(){
        double diff = (getUpperBound().getTime() - getLowerBound().getTime()) / (1000 * 60 * 60 *24);
        diff = 1000/diff;
        return diff;
    }
    ...
    protected List<Date> calculateTickValues(double v, Object range) {
        ...
        double averageTickGap = averageTickGap();
    ...
    public double getDisplayPositionDate(Date StartDate, Date FindDate) {
        final double length = 1000;
        //System.out.println(getWidth())

        // Get the difference between the max and min date.
        double diff = getUpperBound().getTime() - getLowerBound().getTime();
        ...
        // Then get the difference from the actual date to the min date and divide it by the total difference.
        // We get a value between 0 and 1, if the date is within the min and max date.
        double d = (FindDate.getTime() - getLowerBound().getTime()) / diff;
        double d1 = (StartDate.getTime() - getLowerBound().getTime()) / diff;
        //System.out.println(d);
        //System.out.println(0.16 * range + getZeroPosition());

        // Multiply this percent value with the range and add the zero offset.
        return (d * range + getZeroPosition()) - (d1 * range + getZeroPosition());
    }
}
